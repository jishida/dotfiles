...
call s:nmap('t.t' , 'call TabNewWithTerminal("bash")' , 'new-bash'      )
call s:nmap('t.z' , 'call TabNewWithTerminal("zsh")'  , 'new-zsh'       )
call s:nmap('t.f' , 'call TabNewWithTerminal("fish")' , 'new-fish'      )
